...
// Inter font family - Modern, geometric, production-tested (Samsung-safe XML approach)
// Uses XML font family with proper weight declarations to avoid Samsung device crashes
val InterFontFamily = try {
    FontFamily(Font(R.font.inter_font_family))
} catch (e: Exception) {
    Log.e("QuantraTheme", "Failed to load Inter font, using system default", e)
    FontFamily.Default  // Graceful fallback to Roboto
}

// HD Contrast Typography - Using Inter font for modern, professional aesthetic
