...
- **2025-11-20**: Version 3.1.0 released with Bundled Ensemble AI Engine + APK Size Optimization:
  - **AI Engine**: Replaced single 555MB Gemma model with 2 bundled quantized TFLite models (total ~47MB): all-MiniLM-L6-v2 sentence embeddings (22MB) and MobileBERT Q&A INT8 (25MB). Makes AI responses 5-10x faster for common questions. Models auto-provision from assets on first launch - NO USER IMPORT REQUIRED! EmbeddingsRetriever provides instant answers via cosine similarity search against QAKnowledgeBase (198 pre-written pattern/trading Q&As), MobileBERT generates answers for novel questions. All processing remains 100% offline.
