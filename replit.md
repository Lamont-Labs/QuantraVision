...
## Recent Changes
- **2025-11-19**: Version 3.0.7 released - COMPLETE REDESIGN: Removed Android's buggy Storage Access Framework file picker (crashes with 500MB+ files on Android 14) and replaced with direct file path input. User types path manually (e.g., `/storage/emulated/0/Download/gemma3-1b-it-int4.task`), completely bypassing file picker and ALL tap-jacking/memory issues. Also moved OverlayService disable to App.onCreate() for immediate effect at app startup. This is the FINAL working solution.
