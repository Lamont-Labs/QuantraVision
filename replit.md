...
## Recent Changes
- **2025-11-19**: Fixed model import stuck at 0% - file size now passed from Controller to Worker via WorkManager inputData instead of re-querying URI (which failed in worker context due to permission/context issues)
