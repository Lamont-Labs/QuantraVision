...
## Recent Changes
- **2025-11-19**: Version 3.0.4 released - CRITICAL FIX: Found real crash cause - ImportActivity wasn't persisting file access permission! Now calls takePersistableUriPermission() to maintain file access after activity finishes. Added defensive SecurityException handling in ImportModelWorker. The "app has a bug" error was misleading - it wasn't OverlayService at all, but lost file permissions. Ready for production build.
