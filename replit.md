...
## Recent Changes
- **2025-11-19**: Fixed MediaPipe API compatibility issue - corrected GemmaEngine to use proper MediaPipe 0.10.27 API structure with `LlmInference.LlmInferenceOptions` nested class and direct `setModelPath()` instead of incorrect `BaseOptions` approach
