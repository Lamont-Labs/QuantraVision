...
## Recent Changes
- **2025-11-19**: Version 3.0.1 released - Fixed NeonButton reference (component doesn't exist, changed to MetallicButton). Fixed exhaustive when expression (added missing ModelState branches). Fixed NeonText textAlign parameter (moved to style). Ready for production build.
