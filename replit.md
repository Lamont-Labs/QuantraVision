...
- **Bottom Navigation Structure**: Features a 5-tab Material 3 NavigationBar with Home, Markets, Scan, QuantraBot (AI Assistant), and Settings sections, each offering specific functionalities and information. QuantraBot replaced the Learn tab to provide direct access to AI-powered pattern assistance.
